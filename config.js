...
module.exports = {
     ...
     */
    botname: process.env.BotName || "DARK THARIYA",
    footer: process.env.Footer || "© 𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲 THARI BOT",
     ...
     */
    ownername: process.env.Owner_Name || "DARK THARIYA",
    ownernumber: process.env.Owner_Number || "0768358007",
    instagramId: process.env.Insta || "3.69_pika",

    /**
     * other details and parameters
     */
    author: process.env.Author || "@DARK THARIYA",
    packname: process.env.PackName || "DARK THARIYA  🪀",
    ...
    mongoUrl: process.env.MongoDB || "mongodb+srv://recovera347:zg7h5pDexig1fHDQ@cluster0.q6b4o.mongodb.net/",
    sessionId: process.env.SESSION_ID || "bW9ieTk_Queen-Anya_5OTM=",
